...
//  compactRender(render(json4)) // {"name":"joe","age":35}
//  val json5 = ("name" -> "joe") ~ ("age" -> (None: Option[Int]))
//  compactRender(render(json5))  //{"name":"joe"}
//
//
...
//              ("numbers" -> w.numbers))}))
//
//  println(compactRender(render(json6)))
