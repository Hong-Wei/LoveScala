package wangjialin.scala.hello
/**
 * Author: 	Wang Jialin
 * Contact Information:
 * 	WeChat:	18610086859
...
object ScalaInAction {
  println("Welcome to the Scala worksheet")       //> Welcome to the Scala worksheet
   ...
   val s = Array("Hello", "World")                //> s  : Array[String] = Array(Hello, World)
    ...
    b += 1                                        //> res1: wangjialin.scala.hello.ScalaInAction.b.type = ArrayBuffer(1)
    b += (1, 2, 3, 5)                             //> res2: wangjialin.scala.hello.ScalaInAction.b.type = ArrayBuffer(1, 1, 2, 3, 5)
    b ++= Array(8, 13, 21)                        //> res3: wangjialin.scala.hello.ScalaInAction.b.type = ArrayBuffer(1, 1, 2, 3, 5, 8
                                                  //| , 13, 21)
...
scores += ("R" -> 9)                              //> res23: wangjialin.scala.hello.ScalaInAction.scores.type = Map(Hadoop -> 8, R ->
                                                  //|  9, Spark -> 10, Scala -> 7)
  scores -= "Hadoop"                              //> res24: wangjialin.scala.hello.ScalaInAction.scores.type = Map(R -> 9, Spark -> 
                                                  //| 10, Scala -> 7)
...
val regex="""([0-9]+) ([a-z]+)""".r               //> regex  : scala.util.matching.Regex = ([0-9]+) ([a-z]+)
    ...
    val regex(num, blog) = line                   //> scala.MatchError: 20150623 Spark (of class java.lang.String)
                                                  //| 	at wangjialin.scala.hello.ScalaInAction$$anonfun$main$1.apply$mcV$sp(com.dt.
                                                  ...
                                                  //| 	at wangjialin.scala.hello.ScalaInAction$.main(wangjialin.scala.hello.ScalaInActi
                                                  //| on.scala:10)
                                                  //| 	at wangjialin.scala.hello.ScalaInAction.main(wangjialin.scala.hello.ScalaInActio
                                                  //| n.scala)
